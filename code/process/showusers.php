                            ...
                            <form action="showusers.php" method="get" class="form-inline justify-content-center">
                                ...
                                <div class="form-group mx-2">
                                    <select name="tipo_usuario" class="form-control">
                                        ...
                                        <option value="2" <?php echo (isset($_GET['tipo_usuario']) && $_GET['tipo_usuario'] == '2') ? 'selected' : ''; ?>>Administrador</option>
                                        <option value="1" <?php echo (isset($_GET['tipo_usuario']) && $_GET['tipo_usuario'] == '1') ? 'selected' : ''; ?>>Abogado</option>
                                    </select>
                                </div>
                                <div class="form-group mx-2">
